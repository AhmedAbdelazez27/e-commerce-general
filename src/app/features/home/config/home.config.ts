...
export const HOME_PAGE_CONFIG: HomePageConfig = {
  hero: {
    ...
    slides: [
      ...
      {
        id: 'derma',
        imageSrc: '/images/unnamed.png',
        imageAltKey: 'HOME.HERO.SLIDE2_IMAGE_ALT',
        eyebrowKey: 'HOME.HERO.SLIDE2_EYEBROW',
        headlineKey: 'HOME.HERO.SLIDE2_HEADLINE',
        subtitleKey: 'HOME.HERO.SLIDE2_SUBTITLE',
        ctaLabelKey: 'HOME.HERO.SLIDE2_CTA',
        ctaRoute: '/shop',
        ctaQuery: { category: 'skin-care' },
      },
      {
        id: 'perfume',
        imageSrc: '/images/HomeCover.png',
        imageAltKey: 'HOME.HERO.SLIDE3_IMAGE_ALT',
        eyebrowKey: 'HOME.HERO.SLIDE3_EYEBROW',
        headlineKey: 'HOME.HERO.SLIDE3_HEADLINE',
        subtitleKey: 'HOME.HERO.SLIDE3_SUBTITLE',
        ctaLabelKey: 'HOME.HERO.SLIDE3_CTA',
        ctaRoute: '/shop',
        ctaQuery: { category: 'perfume' },
        secondaryCtaLabelKey: 'HOME.HERO.SECONDARY_CTA',
        secondaryCtaRoute: '/shop',
        secondaryCtaQuery: { sort: 'new' },
      },
    ],
  },
  curatedCollections: {
